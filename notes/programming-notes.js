...
then replace comments to easily comment out export
and use plain js file
add comments to functions to easily find

//INDEX
///*
export {
  //returns array of numbers, map coordinates
functionhere,
//returns array of booleans, coordinate is on land
function2here,
}
//*/
